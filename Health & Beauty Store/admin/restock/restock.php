    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_content">
            <main id="main-content">
                <h1>Restock</h1>
                <br>
        <a href="form_restock.php">Update</a>
                <div class="jobs">
                            ...
                            <tbody>
                                ...
                                foreach ($rs as $row) {
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-outline-primary" href="view_restock.php?id=<?= $row['id'] ?>">View</a>
                                        <a class="btn btn-outline-primary"
                                            href="form_restock.php?id=<?= $row['id'] ?>">Edit</a>
                                        <a class="btn btn-outline-primary" href="delete_restock.php?id=<?= $row['id'] ?>"
                                            onclick="if(!confirm('Anda Yakin Hapus Data <?= $row['restock_number'] ?>?')) {return false}">Delete</a>
                                    </td>                                                    
                                    </tr>
                                    <?php
