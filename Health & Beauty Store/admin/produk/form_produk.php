        ...
        <div id="layoutSidenav_content">
            ...
            <form method="POST" action="proses_produk.php">
                <div class="form-group row">
                    <label for="sku" class="col-4 col-form-label">No</label>
                    <div class="col-8">
                        <div class="input-group">
                ...
                <br>
                <div class="form-group row">
                    <label for="min_stock" class="col-4 col-form-label">Minimum Stok</label>
                    <div class="col-8">
                        <div class="input-group">
                            <div class="input-group-prepend">
                            </div>
                ...
                <br>
                <div class="form-group row">
                    <label for="jenis" class="col-4 col-form-label">Restock Number</label>
                    <div class="col-8">
                        <?php
                        $sqlrestock = "SELECT * FROM restock";
                        $rsrestock = $dbh->query($sqlrestock);
                        ?>
                        <select id="restock" name="restock" class="custom-select">
                            <?php
                            foreach ($rsrestock as $rowrestock) {
                                ?>
                                <option value="<?= $rowrestock['id'] ?>"><?= $rowrestock['restock_number'] ?></option>
                                <?php
                            }
                            ?>
                        </select>
