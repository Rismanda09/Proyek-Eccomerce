    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_content">
            <main id="main-content">
                <h1>List Produk</h1>
                <br>
                <a href="form_produk.php">Update</a>
                <div class="jobs">
                                ...
                                foreach ($rs as $row) {
                                    ...
                                    <th scope="row"><?= $nomor ?></th>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-outline-primary" href="form_produk.php?id=<?= $row['id'] ?>">Edit</a>
                                            <a class="btn btn-outline-primary" href="delete_produk.php?id=<?= $row['id'] ?>"
