    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_content">
            <main id="main-content">
                <h1>List Customer Beauty</h1>
                <br>
                <a href="form_customer.php">Update</a>
                <div class="jobs">
                            ...
                            <tbody>
                                ...
                                foreach ($rs as $row) {
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-outline-primary" href="view_customer.php?id=<?= $row['id'] ?>">View</a>
                                        <a class="btn btn-outline-primary"
                                            href="form_customer.php?id=<?= $row['id'] ?>">Edit</a>
                                        <a class="btn btn-outline-primary" href="delete_customer.php?id=<?= $row['id'] ?>"
