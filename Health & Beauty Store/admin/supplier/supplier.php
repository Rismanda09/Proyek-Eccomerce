    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_content">
            <main id="main-content">
                <h1>Supplier Beauty</h1>
                <br>
                <a href="form_supplier.php">Update</a>
                <div class="jobs">
                    <div class="table-responsive">
                        <table class="table table-striped" width="100%">
                            ...
                            <td>         
                            <a class="btn btn-outline-primary" href="view_supplier.php?id=<?= $row['id'] ?>">View</a>
                            <a class="btn btn-outline-primary" href="form_supplier.php?id=<?= $row['id'] ?>">Edit</a>
                            <a class="btn btn-outline-primary" href="delete_supplier.php?id=<?= $row['id'] ?>"
