...
<?php
// cek apakah terdapat parameter ID pada URL, jika ada maka edit data
    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_content">
            ...
            <form method="POST" action="proses_orders.php">
                    ...
                    <div class="col-8">
                        <div class="input-group">
                            ...
                            <input id="order_number" name="order_number" type="text" class="form-control" 
                                value="<?php if (isset($row['order_number']))
                ...
                <br>
                <div class="form-group row">
                    <label for="total_price" class="col-4 col-form-label">Total</label>
                    <div class="col-8">
                        <div class="input-group">
                            <div class="input-group-prepend">
                            </div>
