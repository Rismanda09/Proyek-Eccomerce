    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_content">
            <main id="main-content">
                ...
                <br>
                <a href="form_orders.php">Update</a>
                <div class="jobs">
                        ...
                        <table class="table table-striped" width="100%">
                            ...
                            <tbody>
                                ...
                                foreach ($rs as $row) {
                                    ...
                                    <a class="btn btn-outline-primary" href="view_orders.php?id=<?= $row['id'] ?>">View</a>
                                    <a class="btn btn-outline-primary" href="form_orders.php?id=<?= $row['id'] ?>">Edit</a>
                                    <a class="btn btn-outline-primary" href="delete_orders.php?id=<?= $row['id'] ?>"
                                        onclick="if(!confirm('Anda Yakin Hapus Data <?= $row['order_number'] ?>?')) {return false}">Delete</a>
                                    </td>
                                    </tr>
                                    <?php
                                    $id++;
