                    ...
                    <div class="nav">
                        ...
                        <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne"
                            ...
                            <nav class="sb-sidenav-menu-nested nav">
                                ...
                                <a class="nav-link" href="../type produk/type.php" id="col-hover">Type Produk</a>
                            </nav>
                        </div>
                ...
                <div class="jobs">
                    <div class="table-responsive">
                        <table class="table table-striped" width="100%">
                            ...
                            <td>
                                <a class="btn btn-outline-primary" href="view_type.php?id=<?= $row['id'] ?>">View</a>
                                <a class="btn btn-outline-primary" href="form_type.php?id=<?= $row['id'] ?>">Edit</a>
                                <a class="btn btn-outline-primary" href="delete_type.php?id=<?= $row['id'] ?>"
