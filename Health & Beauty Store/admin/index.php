                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link" href="produk/produk.php">Product</a>
                                    <a class="nav-link" href="type produk/type.php">Type Product</a>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Dashboard Beauty</h1>
                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="h5 text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Items Product</div>
                                            <div class="h6 mb-0 font-weight-bold text-gray-800">150 product</div>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="h3 text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Stock</div>
                                            <div class="h6 mb-0 font-weight-bold text-gray-800">1000 stock</div>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="h3 text-xs font-weight-bold text-danger text-uppercase mb-1">
                                                User</div>
                                            <div class="h6 mb-0 font-weight-bold text-gray-800">550 New Member</div>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="h5 text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                Total Order</div>
                                            <div class="h6 mb-0 font-weight-bold text-gray-800">108 order</div>
                                        </div>
                                        <div class="col-auto">
