                        ...
                        <table class="table table-striped" width="100%">
                            ...
                            <tbody>
                                ...
                                foreach ($rs as $row) {
                                    ...
                                    <a class="btn btn-outline-primary" href="view_card.php?id=<?= $row['id'] ?>">View</a>
                                    <a class="btn btn-outline-primary" href="form_card.php?id=<?= $row['id'] ?>">Edit</a>
                                    <a class="btn btn-outline-primary" href="delete_card.php?id=<?= $row['id'] ?>"
                                        onclick="if(!confirm('Anda Yakin Hapus Data <?= $row['code'] ?>?')) {return false}">Delete</a>
                                    </td>
                                    </tr>
                                    <?php
                                    $id++;
