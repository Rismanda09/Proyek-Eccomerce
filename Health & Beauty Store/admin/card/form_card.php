    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_content">
            ...
            <div class="form-group row">
                    ...
                    <div class="col-8">
                        <?php
                        $sqlcode = "SELECT * FROM card";
                        $rscode = $dbh->query($sqlcode);
                        ?>
                        <select id="code" name="code" class="custom-select">
                            <?php
                            foreach ($rscode as $rowcode) {
                            ?>
                            <option value="<?= $rowcode['id'] ?>"><?= $rowcode['code'] ?></option>
                            <?php
                            }
                            ?>
                        </select>
                ...
                <br>
                <div class="form-group row">
                    <label for="dicsount" class="col-4 col-form-label">Discount</label>
                    <div class="col-8">
                        <div class="input-group">
                            <div class="input-group-prepend">
                            </div>
                            <input id="discount" name="discount" value="
                            <?php if (isset($row['discount']))
                                echo $row['discount']; ?>" type="text" class="form-control">
                        </div>
                    </div>
                </div>
                <br>
                <div class="form-group row">
                    ...
                    <div class="col-8">
                        <div class="input-group">
                            ...
                            <input id="contact_name" name="contact_name" value="
                            <?php if (isset($row['contact_name']))
                                echo $row['contact_name']; ?>" type="text" class="form-control">
                        </div>
                    </div>
                </div>
                <br>
